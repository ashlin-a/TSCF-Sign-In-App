...
export default function Navbar() {
    ...
    return (
        <nav className="flex justify-between justify-items-center p-2 px-5">
            ...
            <div
                className={`absolute left-0 top-12 flex w-full transform flex-col items-center justify-center gap-5 bg-bkg transition-transform lg:hidden ${isMenuOpen ? 'opacity-100' : 'opacity-0'}`}
