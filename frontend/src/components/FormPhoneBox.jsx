export function FormPhoneBox({ text, onChange, readOnly, value,}) {
  return (
    <div>
      <p className="font-semibold">{text}</p>
      <input
        onChange={onChange} readOnly={readOnly} value={value} pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' placeholder='123-456-6789' title='123-456-6789'
